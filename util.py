...
def make_socket(address):
    ...
    print("Now listening at {}:{}".format( address[0], address[1]))
    return s
...
class Chat(object):
    ...
    def welcome_new(self, new_player):
        new_player.socket.sendall(b'Welcome to chatty.\nPlease tell us your name:\n')

    def list_rooms(self, player):
        
        if len(self.rooms) == 0:
            msg = 'There is no active rooms currently. Create your own room.\n' \
